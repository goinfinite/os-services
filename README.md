...
| -- | -- | -- |
| `v0` | [`v0.0.1`](https://github.com/goinfinite/os/releases/tag/v0.0.1) through [`v0.1.5`](https://github.com/goinfinite/os/releases/tag/v0.1.5) | `v1` |
| `v1` | [`v0.1.7`](https://github.com/goinfinite/os/releases/tag/v0.1.7) through [`v0.3.2`](https://github.com/goinfinite/os/releases/tag/v0.3.2) | `v1` |
| `v2` | [`v0.3.3`](https://github.com/goinfinite/os/releases/tag/v0.3.3) and later | `v1` |
...
[PHP WebServer example](https://github.com/goinfinite/os-services/blob/v1/runtime/php-webserver/manifest.yml).
...
Services may ship an `assets/` directory with useful files: install scripts,
configuration templates, and images. Install commands receive the directory
path through the `%installableServiceAssetsDirPath%` placeholder.

Infinite OS also parses some asset files. The PHP WebServer service ships
`assets/modules.yaml`. It maps each PHP version to the toggleable modules of
that version:
...
The dashboard shows these modules with their live state. The system installs
